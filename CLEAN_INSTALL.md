...
```bash
cd "/Volumes/Grey_1TB/Industry PWA/childcare-roster-pwa"
rm -rf .git
git init
git add .
git commit -m "Initial commit"
git branch -M main
git remote add origin https://github.com/<your-username>/childcare-roster-pwa.git
...
```bash
cd "/Volumes/Grey_1TB/Industry PWA/childcare-roster-pwa"
gh repo create <your-username>/childcare-roster-pwa --public --source=. --remote=origin --push
```

## If the remote repo already exists and you want to clone it
```bash
git clone https://github.com/<your-username>/childcare-roster-pwa.git
cd childcare-roster-pwa
